import ROOT
import math
# code that displays both a poisson and breit-wigner distribution on same graph
...
# rebinning breit-wigner histogram
bwhist.Rebin(2)
# fitting gaussian to poishist; extracted parameters appear in terminal
poishist.Fit("gaus")
# adding legend
leg = ROOT.TLegend(.15, .7, .3, .85)
leg.AddEntry(poishist, "poisson")
